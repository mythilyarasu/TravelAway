...
const handleNav = () => {
  ...
  return (
    <div className="w-full min-h-[50px] flex justify-between items-center absolute z-10 text-white bg-gray-700" >
        ...
        className= { nav ? 'overflow-y-hidden md:hidden ease-in duration-300 absolute w-full h-screen bg-black/90 text-gray-300 left-0 top-0 px-4 py-8 flex flex-col' : 'absolute top-0 h-screen left-[-100%] ease-in duration-500'}>

  ...
  return (
    <div className='max-w-[1140px] m-auto w-full md:flex mt-[-75px]'>
      ...
      <div className='relative p-4 cursor-pointer'>
        ...
        <img className='w-full h-full object-cover relative border-4 border-white shadow-lg'
        src="https://images.unsplash.com/photo-1561501878-aabd62634533?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" alt='' />
      </div>
      <div className='relative p-4 cursor-pointer'>
